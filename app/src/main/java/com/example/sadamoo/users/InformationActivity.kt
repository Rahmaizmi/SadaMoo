...
class InformationActivity : AppCompatActivity() {
    ...
    private fun setupDiseaseData() {
        allDiseases = listOf(
            ...
            Disease(
                ...
                description = "Penyakit virus akut yang sangat menular pada hewan berkuku belah, ditandai dengan lepuh dan luka pada mulut, lidah, dan kuku [[1]].",
                symptoms = listOf(
                    "Lepuh berisi cairan pada lidah, gusi, dan hidung [[7]]",
                    "Luka pada kuku dan sela-sela kuku",
                    "Hewan pincang dan sulit berjalan [[7]]",
                    "Air liur berlebihan (hipersalivasi) [[7]]",
                    "Demam tinggi (40-41°C)",
                    "Nafsu makan hilang [[7]]",
                    "Penurunan produksi susu drastis",
                    "Kelemahan dan depresi"
                ),
                causes = listOf(
                    "Infeksi virus Foot and Mouth Disease Virus (FMDV) [[9]]",
                ...
                prevention = listOf(
                    "Vaksinasi rutin sesuai program pemerintah [[3]]",
                    "Biosekuriti ketat di peternakan [[10]]",
            ...
            Disease(
                ...
                description = "Penyakit virus yang menyerang sapi dan kerbau, ditandai dengan benjolan-benjolan pada kulit yang dapat menyebabkan kerugian ekonomi signifikan [[4]].",
                symptoms = listOf(
    ...
    private fun setupRecyclerView() {
        diseaseAdapter = DiseaseAdapter(filteredDiseases) { disease ->
            // Handle disease item click - navigate to detail
            // startActivity(Intent(this, DiseaseDetailActivity::class.java).apply {
            //     putExtra("disease_id", disease.id)
            // })
        }
